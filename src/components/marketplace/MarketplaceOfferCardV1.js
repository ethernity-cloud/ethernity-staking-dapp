...
import { AuditOutlined, RightOutlined, StopOutlined, CreditCardOutlined } from '@ant-design/icons';
...
const MarketplaceOfferCardV1 = ({
  ...
  <Card className="rounded-2xl bg-gray-100 dark:bg-gray-800 border-0 cursor-pointer" loading={loading}>
    ...
    {status !== StakingPotStatus.DECLINED && (
      <div className="flex items-center justify-between w-full space-x-2">
        {status !== StakingPotStatus.APPROVED && !isMarketplace && (
          <Button
            type="text"
            className="w-full uppercase text-green-500 font-bold hover:bg-green-100"
            onClick={onApprove}
          >
            Approve
            <RightOutlined />
