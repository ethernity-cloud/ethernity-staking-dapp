    ...
    <div className="flex items-center justify-center h-16">
      ...
      >
        <g>
          <path
            id="main"
            fill={theme === THEME_LIGHT ? '#FFFFFF' : '#ffffff'}
		...
		c11.6,11.7,30.5,11.7,42.1,0l51.8-52.4l0,0c16-17.1,44.2-17.3,61.2-0.2v-0.1C194.5,30.1,198.4,38.1,200,46.3z"
          ...
          <path
            id="accent"
            fill={theme === THEME_LIGHT ? '#FFFFFF' : '#0C86FF'}
      ...
      <span className="font-sans text-center text-xl text-white pl-2">Ethernity Cloud</span>
    </div>
  );
};
